...
"""
def read_images_from_disk(input_file, input_size, random_scale, random_mirror=False): # optional pre-processing arguments
    ...
    #img_contents = tf.read_file(input_file)
    #print("----------------------------:", img_contents.shape)
...
class ImageReader(object):
    ...
    def __init__(self, data_dir, data_list, data_id_list, input_size, random_scale,
        ...
        """
        self.image = read_images_from_disk(img, self.input_size, random_scale, random_mirror) 
